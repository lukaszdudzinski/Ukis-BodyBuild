      ...
      - generic [ref=f1e29]:
        ...
        - generic [ref=f1e33]:
          - generic [ref=f1e34]:
            ...
            - paragraph [ref=f1e36]: Ostatni pomiar robiłeś 2 dni temu. Trzymaj tak dalej!
          - paragraph [ref=f1e37]: Za mało danych treningowych do przeprowadzenia analizy.
          - heading "Analiza składu ciała" [level=4] [ref=f1e38]
          - generic [ref=f1e39]:
            - generic [ref=f1e40]:
              - strong [ref=f1e41]: Szacunkowy BF%
              - button "ℹ️" [ref=f1e42] [cursor=pointer]
              - generic [ref=f1e43]: 16.1 %
              - paragraph [ref=f1e44]: Dobra kondycja (Fitness)
              - paragraph [ref=f1e45]: Tkanka tłuszczowa wg wzoru US Navy
            - generic [ref=f1e46]:
              - strong [ref=f1e47]: FFMI (Index Beztłuszczowy)
              - button "ℹ️" [ref=f1e48] [cursor=pointer]
              - generic [ref=f1e49]: "20.7"
              - paragraph [ref=f1e50]: Dobra muskulatura (Wysportowany)
              - paragraph [ref=f1e51]: Wskaźnik suchej masy mięśniowej
            - generic [ref=f1e52]:
              - strong [ref=f1e53]: WHR (Talia-Biodra)
              - button "ℹ️" [ref=f1e54] [cursor=pointer]
              - generic [ref=f1e55]: "0.89"
              - paragraph [ref=f1e56]: Zdrowe proporcje (Niskie ryzyko)
              - paragraph [ref=f1e57]: Proporcje sylwetki
          - generic [ref=f1e58]:
            - button "📤 Udostępnij swój progres" [ref=f1e59] [cursor=pointer]
            - paragraph [ref=f1e60]: Pochwal się na Facebooku lub Instagramie!
  - text: ✕
