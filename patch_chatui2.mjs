...
// Replace the buggy drag logic with better one
const startIdx = js.indexOf('// --- DRAGGABLE LOGIC ---');
const endIdx = js.indexOf('// -----------------------') + 26;

if (startIdx !== -1 && endIdx !== -1) {
    const dragLogic = `// --- DRAGGABLE LOGIC ---
    ...
    js = js.slice(0, startIdx) + dragLogic + js.slice(endIdx);
    fs.writeFileSync('src/modules/ui/ChatUI.js', js);
    console.log('ChatUI patched with better draggable logic');
}
