...
- Name: version_verification.spec.js >> Weryfikacja wersji v2026.8.22.02 i mechanizmu PWA Updater >> 1. Statyczna zgodność wersji we wszystkich plikach projektu (PWA Golden Rule)
- Location: tests/e2e/version_verification.spec.js:32:3
