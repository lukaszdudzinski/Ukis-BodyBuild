    ...
    - main [ref=f1e27]:
      - generic [ref=f1e29]:
        ...
        - generic [ref=f1e33]:
          ...
          - generic [ref=f1e41]:
            - generic [ref=f1e42]:
              - strong [ref=f1e43]: Szacunkowy BF%
              - button "ℹ️" [ref=f1e44] [cursor=pointer]
              - generic [ref=f1e45]: 16.1 %
              - paragraph [ref=f1e46]: Dobra kondycja (Fitness)
              - paragraph [ref=f1e47]: Tkanka tłuszczowa wg wzoru US Navy
            - generic [ref=f1e48]:
              - strong [ref=f1e49]: FFMI (Index Beztłuszczowy)
              - button "ℹ️" [ref=f1e50] [cursor=pointer]
              - generic [ref=f1e51]: "20.7"
              - paragraph [ref=f1e52]: Dobra muskulatura (Wysportowany)
              - paragraph [ref=f1e53]: Wskaźnik suchej masy mięśniowej
            - generic [ref=f1e54]:
              - strong [ref=f1e55]: WHR (Talia-Biodra)
              - button "ℹ️" [ref=f1e56] [cursor=pointer]
              - generic [ref=f1e57]: "0.89"
              - paragraph [ref=f1e58]: Zdrowe proporcje (Niskie ryzyko)
              - paragraph [ref=f1e59]: Proporcje sylwetki
          - generic [ref=f1e60]:
            - button "📤 Udostępnij swój progres" [ref=f1e61] [cursor=pointer]
            - paragraph [ref=f1e62]: Pochwal się na Facebooku lub Instagramie!
  - text: ✕
