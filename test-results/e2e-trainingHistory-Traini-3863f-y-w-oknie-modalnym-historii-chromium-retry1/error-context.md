...
Call log:
  - waiting for locator('#history-dashboard').getByText('Trening z superserią test 1789722365877').first()
    - locator resolved to <strong>Trening z superserią test 1789722365877</strong>
        ...
        - generic [ref=f1e9]:
          ...
          - generic [ref=f1e15]:
            ...
            - generic [ref=f1e31] [cursor=pointer]:
              - strong [ref=f1e32]: Trening z superserią test 1789722365877
              - text: 1 ćwiczeń • 0 kg
    - generic [ref=f1e36]:
