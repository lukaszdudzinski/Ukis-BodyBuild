        ...
        return `
            ...
            <form id="measurementsForm" style="padding: 0 15px; margin-bottom: 30px;">
                ...
                <div style="display: flex; gap: 15px; margin-top: 20px;">
                    <button type="submit" class="pulse" style="display: flex; align-items: center; justify-content: center; gap: 8px; flex: 2; background: #FF9800; border: none; padding: 18px; border-radius: 16px; font-size: 1.1em; font-weight: 700; cursor: pointer; color: #111118; transition: opacity 0.2s;">
